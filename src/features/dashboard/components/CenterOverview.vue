      ...
      <svg class="hub-svg" viewBox="0 0 200 200">
        ...
        <defs>
          <radialGradient id="hubGlow" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="70%" stop-color="rgba(37,99,235,0.06)" />
            <stop offset="100%" stop-color="rgba(37,99,235,0.0)" />
          </radialGradient>
        </defs>

        <!-- 巅峰中枢圆 -->
        <circle cx="100" cy="100" r="16" fill="#eef3fb" stroke="#2563eb" stroke-width="2.5" />
        <text
          x="100"
          y="97"
          text-anchor="middle"
        ...
        <g v-if="data.nodes[0]">
          ...
          <text x="20" y="42" text-anchor="middle" fill="var(--dv-text-dim)" font-size="6">
        ...
        <g v-if="data.nodes[1]">
          ...
          <text x="180" y="42" text-anchor="middle" fill="var(--dv-text-dim)" font-size="6">
        ...
        <g v-if="data.nodes[2]">
          ...
          <text x="20" y="182" text-anchor="middle" fill="var(--dv-text-dim)" font-size="6">
        ...
        <g v-if="data.nodes[3]">
          ...
          <text x="180" y="182" text-anchor="middle" fill="var(--dv-text-dim)" font-size="6">
